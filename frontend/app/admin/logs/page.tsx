            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-secondary/30">
                  ...
                  <th className="text-left text-xs font-medium text-muted-foreground p-4 hidden md:table-cell">Details</th>
                  <th className="text-left text-xs font-medium text-muted-foreground p-4 hidden lg:table-cell">IP Address</th>
              ...
              <tbody>
                {filteredLogs.map((log, index) => (
                  ...
                  >
                    <td className="p-4">
                      <Badge variant="outline" className={`bg-${getActionBadge(log.action)}/10 text-${getActionBadge(log.action)} border-${getActionBadge(log.action)}/20`}>
                        {log.action}
                      </Badge>
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4 hidden lg:table-cell">
                      <code className="text-xs bg-secondary px-2 py-1 rounded">{log.ip}</code>
                    </td>
                    <td className="p-4">
                      <div className="flex items-center gap-2">
